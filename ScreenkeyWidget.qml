...
PluginComponent {
    ...
    horizontalBarPill: Component {
        Item {
            ...
            StyledRect {
                id: pillRect
                width: iconItem.width + Theme.spacingM * 2
                height: parent.height
                radius: Theme.cornerRadius
                color: root.enabled ? Theme.withAlpha(Theme.primary, 0.15) : "transparent"
                ...
                DankIcon {
                    ...
                    color: root.enabled ? Theme.primary : Theme.surfaceText
    ...
    verticalBarPill: Component {
        Item {
            ...
            implicitHeight: pillRect.height

            StyledRect {
                id: pillRect
                width: parent.width
                height: iconItem.height + Theme.spacingM * 2
                radius: Theme.cornerRadius
                color: root.enabled ? Theme.withAlpha(Theme.primary, 0.15) : "transparent"
